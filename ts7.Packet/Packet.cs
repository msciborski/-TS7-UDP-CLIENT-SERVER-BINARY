    ...
    public class Packet {
        ...
        public class Packet {
            ...
            public static Packet Deserialize(byte[] bytes) {
                ...
                Packet packet = new Packet(GetIntFromBitArray(idBitArray), GetIntFromBitArray(dataBitArray), (AnswerEnum)GetIntFromBitArray(answerBitArray), (OperationEnum)GetIntFromBitArray(operationBitArray));
